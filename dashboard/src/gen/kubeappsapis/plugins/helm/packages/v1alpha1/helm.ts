...
export const RepositoryCustomDetails = {
  encode(
    message: RepositoryCustomDetails,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.filterRule = RepositoryFilterRule.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  toJSON(message: RepositoryCustomDetails): unknown {
    ...
    message.filterRule !== undefined &&
      (obj.filterRule = message.filterRule
        ...
        : undefined);
    message.performValidation !== undefined &&
      (obj.performValidation = message.performValidation);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<RepositoryCustomDetails>, I>>(
    ...
    const message = createBaseRepositoryCustomDetails();
    message.dockerRegistrySecrets =
      object.dockerRegistrySecrets?.map((e) => e) || [];
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 4:
          const entry4 = RepositoryFilterRule_VariablesEntry.decode(
            reader,
            reader.uint32()
          );
...
export const RepositoryFilterRule_VariablesEntry = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<RepositoryFilterRule_VariablesEntry>, I>
  >(object: I): RepositoryFilterRule_VariablesEntry {
    const message = createBaseRepositoryFilterRule_VariablesEntry();
